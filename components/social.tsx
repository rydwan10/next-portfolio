...
const Social: React.FC = () => {
    return (
        <div className="flex gap-y-4 items-center flex-wrap">
            ...
            <a href="/assets/pdf/rydwan_cv_2024.pdf" target="_blank" rel="noopener noreferrer" className="rounded-full border-2 border-purple-500 px-4 py-2 flex items-center space-x-2 text-white">
